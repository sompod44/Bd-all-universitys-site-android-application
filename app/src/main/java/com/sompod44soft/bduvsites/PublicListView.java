...
public class PublicListView extends AppCompatActivity {
public String[] PublicUniversitys;
ListView listView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_public_list_view);

        listView = findViewById(R.id.listviewid);
        PublicUniversitys = getResources().getStringArray(R.array.public_universitys);

            CustomAdaptor customAdaptor = new CustomAdaptor(this,PublicUniversitys); // This is Custom Adaptor
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) { // int i here position of listview item
                Intent intent =  new Intent(PublicListView.this,PublicWebView.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.shareID){
            ...
            try{
                Intent intent = new Intent(PublicListView.this,FeedBack.class);
                startActivity(intent);
            }catch (Exception e){
